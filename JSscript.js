...
function randomNumber(){
    firstOne = document.getElementById("first").innerText = rand(1,6);
    secondOne = document.getElementById("second").innerText = rand(1,6);
...
function randomCount(){
    arr.push(rand(1,10));
    console.log(arr);
    arrSum = arr.reduce(function(a,b){
        return a + b;
    }, 0);
    document.getElementById("h3").innerText = arrSum;
}
...
console.log(africa);
z = africa.filter(item => item);
for (i = 0; i < 7; i++){
    const li = document.createElement("li");
    // animalName = africa.shift();
    z.forEach(x => document.getElementById("ul").appendChild(li).innerText = x);
}
...
function plus(){
    ...
    document.getElementById("answer").innerText = countNumbers;
}
